...
/**
 * Wrapper function to start the monitor correctly
 * and call the function that will be use
 */
...
/**
 * Function that will tell us if we should stop,
 * just validating is the philo is died or is full
 */
